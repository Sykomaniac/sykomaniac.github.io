...
import { Container, Title, Card } from 'bloomer'
...
export default class CV extends React.Component {
 ...
 <span class="label">Senior Software Engineer</span>
                <p id="contact"> <span class="email"><a href="mailto:ashleysykes01@gmail.com">ashleysykes01@gmail.com</a></span>
                    <span
                    class="phone">07975 732 684</span> <span class="website"><a href="https://sykomaniac.github.io"><a href="https://sykomaniac.github.io">https://sykomaniac.github.io</a></a></span>
                </p>
            </header>
            <section id="summary">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="keywords">C# Python Java Node.js</td>
                        </tr>
                        <tr>
                            <td style={{ width: "25%" }}>JavaScript Frameworks</td>
                            <td class="keywords">Vue.js Angular AngularJS React Backbone.js Knockout.js Ember.js</td>
                        </tr>
                        <tr>
                            <td style={{ width: "25%" }}>Web Technologies</td>
                            <td class="keywords">HTML 5 CSS Sass LESS Stylus</td>
                        </tr>
                        <tr>
                            <td style={{ width: "25%" }}>Database</td>
                            <td class="keywords">RRDBMS (MSSQL, MaraiaDB, SQLite etc) MongoDB Apache Cassandra</td>
                        </tr>
                        <tr>
                            <td style={{ width: "25%" }}>CI tools</td>
                            <td class="keywords">GitLab Jenkins Team City Docker Kubernetes Nexus Vagrant</td>
                        </tr>
                        <tr>
                            <td style={{ width: "25%" }}>SDLC</td>
                            <td class="keywords">SCRUM Lean Prince 2 XP</td>
                        </tr>
                    </tbody>
                </table>
            </section>
            ...
            <section id="employment">
              ...
              <a href="http://www.edgetic.com/">Edgetic Ltd, Leeds, UK</a>

              </h3>
 <span class="tenure">2018-01 — Present</span>
                    <p>
              ...
              <a href="https://www.asda.com/">Asda Stores Limited, Leeds, UK</a>

              </h3>
 <span class="tenure">2016-06 — 2017-12</span>
                    <p>
 ...
 <span class="tenure">2015-11 — 2016-06</span>
                    <p>
              ...
              <a href="https://www.x-labsystems.co.uk/">X-Lab Ltd, Leeds,UK</a>

              </h3>
 <span class="tenure">2009-06 — 2015-11</span>
                    <p>
 ...
 <span class="tenure">2006-09 — 2009-06</span>
                    <p>Graduated with a First class with honours BSC in Computing</p>
                </div>
                <div>
                     <h3><em>A-Level&#39;s</em>, West Leeds Sixth Form College</h3>
 <span class="tenure">2004-09 — 2006-06</span>
                    <p>Three Grade B&#39;s in English Languages, English Literature and Sports
                        Science.</p> <span class="keywords">A/S-Level Grade B in ICT and Grade C in Biochemistry Cisco IT Essentials 1 and 2 </span>
                </div>
                <div>
                     <h3><em>GCSE&#39;s</em>, West Leeds High School</h3>
 <span class="tenure">1999-09 — 2004-06</span>
